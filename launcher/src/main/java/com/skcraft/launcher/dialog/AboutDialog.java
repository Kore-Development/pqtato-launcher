...
public class AboutDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        container.add(new JLabel("<html><br>"), "wrap, gapbottom unrel");
        container.add(new JLabel("<html>You are using Pqtato Launcher created by Pqtato99."), "wrap, gapbottom unrel");
		container.add(new JLabel("<html><br>"), "wrap, gapbottom unrel");
        ...
        websiteButton.addActionListener(ActionListeners.openURL(this, "http://launcher.pottingpvp.gq"));
    }
